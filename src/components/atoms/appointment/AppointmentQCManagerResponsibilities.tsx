...
const AppointmentQCManagerResponsibilities = () => {
  ...
  const [duties, setDuties] = useState([
    ...
    `Report to an executive of ${companyName}. Incorporated and work in close cooperation with the NAVFAC QA Team and the ${companyName} Board.`,
    ...
    const [add, setadd] = useState(`${companyName}\n`)
