...
const Threephaseupload = () => {
  const [heading, setHeading] = useState("The following checklists (enclosed) are used in conjunction; Preparatory, Initial and Follow-Up Phase reports.");
...
//   const [nonPdfFiles, setNonPdfFiles] = useState<{ name: string; content: JSX.Element }[]>([]);
  ...
  return (
    <>
      <div className="border-4 border-yellow-500 m-6 p-8 bg-white w-[794px] h-[1123px] mx-auto shadow page-number-placeholder relative  break-inside-avoid page-break">
        <EditableText
          tag="p"
...
export default Threephaseupload;
