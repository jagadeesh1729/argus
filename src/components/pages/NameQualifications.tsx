...
const NameQualifications = () => {
  ...
  return (
    <div className="border-4 border-yellow-500 m-6 p-8 bg-white w-[794px] h-[1123px] mx-auto shadow break-inside-avoid page-break text-[15px] leading-relaxed">
      <h2 className="text-center text-amber-700 font-semibold underline mb-6">
