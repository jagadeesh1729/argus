// components/pages/FollowUpPhaseChecklist.tsx
...
const FollowUpPhaseChecklist = () => {
  ...
  return (
    <div className="border-4 border-yellow-500 m-6 p-10 bg-white w-[794px] h-[1123px] mx-auto shadow overflow-hidden break-inside-avoid">
